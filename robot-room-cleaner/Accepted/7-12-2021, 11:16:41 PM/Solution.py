...
class Solution:
    ...
    def cleanRoom(self, robot):
        ...
        def track(robot):
            ...
            # now self.dir is the opposite of when we first visited this cell
            # if we it is the (0, 0) cell, we need explore this dir
            # else, we directly retrieve from this cell to its former one
            # (in the order of cleanning it)
